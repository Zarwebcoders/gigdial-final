                ...
                {activeChat ? (
                    <>
                        ...
                        <div className="px-4 py-3 md:px-6 md:py-4 border-b border-slate-100 flex justify-between items-center bg-white/95 backdrop-blur-xl sticky top-0 z-30 shadow-sm">
                            <div className="flex items-center gap-4 min-w-0">
                                ...
                                <div className="min-w-0 font-bold">
                                    ...
                                    <p className="text-[10px] md:text-xs text-green-600 font-bold uppercase tracking-wider flex items-center gap-1.5">
                        ...
                        <div className="px-4 py-4 md:px-8 md:py-6 bg-white border-t border-slate-100 sticky bottom-0 z-30">
                            ...
                            <div className="flex items-center gap-3 md:gap-4">
                                <div className="flex-1 bg-slate-50 border-2 border-slate-200 focus-within:border-blue-500/30 focus-within:bg-white rounded-[24px] flex items-center px-2 md:px-4 py-1 transition-all">
                                    <button
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center p-12 text-center">
                        ...
                        <p className="text-slate-500 max-w-sm font-bold text-lg leading-relaxed">
                            Start a conversation with workers to get things moving. Your messages will appear here.
                        </p>
                    </div>
                )}
            </div>
